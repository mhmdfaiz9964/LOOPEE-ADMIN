<div class="navbar-header">
    ...
    <a class="navbar-brand" href="<?php echo URL::to('/'); ?>">
        ...
        <b>
            ...
            <img src="{{ asset('/images/logo-sidebar.png') }}" alt="homepage" class="dark-logo" width="100%" id="logo_web" style="border-radius:5px;">

            <img src="{{ asset('images/logo-sidebar.png') }}" alt="homepage" class="light-logo" style="border-radius:5px;">
