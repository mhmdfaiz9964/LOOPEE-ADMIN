    ...
    $(document).ready(function() {
      ...
      $(".save-form-btn").click( async function() {
        ...
        if (userFirstName == '') {
          ...
          $(".error_top").append("<p>{{trans('lang.enter_driver_name_error')}}</p>");
          ...
          $(".error_top").append("<p>{{trans('lang.enter_driver_last_name_error')}}</p>");
          ...
          $(".error_top").append("<p>{{trans('lang.enter_driver_email')}}</p>");
          ...
          $(".error_top").append("<p>{{trans('lang.enter_driver_phone')}}</p>");
