            ...
            <fieldset>
                            ...
                            <div class="form-group row mt-1 ">
                                ...
                                <div class="col-12 switch-box">
                                    ...
                                    <div class="switch-box-inner">
                                        ...
                                        <label class="switch"> <input type="checkbox" name="subscription_model" id="subscription_model"><span class="slider round"></span></label>

                                        <i class="text-dark fs-12 fa-solid fa fa-info" data-toggle="tooltip"

                                            title="{{ trans('lang.subscription_tooltip') }}"
              ...
              <fieldset>
                ...
                <div class="form-group row width-100 switch-box">
                  ...
                  <div class="switch-box-inner">
                    ...
                    <label class="switch"> <input type="checkbox" name="enable_commission" onclick="ShowHideDiv()" id="enable_commission"><span class="slider round"></span></label>

                    <i class="text-dark fs-12 fa-solid fa fa-info" data-toggle="tooltip" title="{{ trans('lang.commission_tooltip') }}" aria-describedby="tippy-3"></i>
              ...
              <fieldset>
                ...
                <div class="form-group row width-100">
                    ...
                    <label class="col-3 control-label">{{ trans('lang.item_store_id') }} <i class="text-dark fs-12 fa-solid fa fa-info" data-toggle="tooltip"
                    ...
                    <div class="col-12">
                        ...
                        <select id="food_restaurant_type" class="form-control" required>
                            ...
                            <option value="all">{{ trans('lang.all_store')}}</option>

                            <option value="custom">{{ trans('lang.custom_store')}}</option>
                ...
                <div class="form-group col-12 text-center">
                        ...
                        <div class="col-12">
                            ...
                            <button type="button" id="bulk_update_btn" class="btn btn-primary edit-setting-btn"><i class="fa fa-save"></i> {{ trans('lang.bulk_update')}}</button>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#food_restaurant_type').on('change', function() {
            ...
            if ($('#food_restaurant_type').val() === 'custom') {
                ...
                $('#food_restaurant').select2({
                    ...
                    placeholder: "{{trans('lang.select_store')}}",
        ...
        $(".edit-setting-btn").click(function(){
          ...
          var howmuch = parseInt($(".commission_fix").val()).toString();
