        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{!! route('stores') !!}">{{ trans('lang.vendor_plural2') }}</a></li>
                        ...
                        <div class="menu-tab">
                            <ul>
                                ...
                                <li class="restaurantRouteLi" style="display:none;">
                                    <a class="restaurantRoute">{{ trans('lang.store') }}</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row width-100">
                                        ...
                                        <div class="form-check provider_type" style="display:none;">
                                            ...
                                            <label class="col-3 control-label"
                                                for="reset_password">{{ trans('lang.reset_store_password') }}</label>
