    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                  <a href="{{url('/storeFilters')}}">{{trans('lang.store_filter')}}</a>
                </li>
                <li class="breadcrumb-item">{{trans('lang.store_filter_create')}}</li>
            </ol>
        </div>
    </div>
        <div class="card-body">
          <div class="row restaurant_payout_create">
            ...
            <fieldset>
              <legend>{{trans('lang.store_filter_create')}}</legend>
              <div class="form-group row width-100">
                  <label class="col-3 control-label">{{ trans('lang.store_filter_name')}}</label>
                  <div class="col-7">
              ...
              <div class="form-group row width-100">
                <label class="col-3 control-label">{{trans('lang.store_filter_options')}}</label>
