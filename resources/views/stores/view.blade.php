                        ...
                        <div class="d-flex top-title-section pb-4 justify-content-between">
                            <div class="d-flex top-title-left align-self-center">
                                ...
                                <div class="top-title-breadcrumb">
                                    <h3 class="mb-0 restaurantTitle">{{ trans('lang.store_plural') }}</h3>
                                    <ol class="breadcrumb">
                ...
                <div class="card border">
                    <div class="card-header d-flex justify-content-between align-items-center border-bottom pb-3">
                        <div class="card-header-title">
                            <h3 class="text-dark-2 mb-0 h4">{{ trans('lang.store_details') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="restaurant_info_left">
                                        ...
                                        <div class="sis-content pl-4">
                                            ...
                                            <ul class="p-0 info-list mb-0">
                                                <li class="d-flex align-items-center mb-2">
                                                    <label class="mb-0 font-wi font-semibold text-dark-2">{{ trans('lang.store_phone') }}</label>
                                                    <span class="restaurant_phone"></span>
                                                </li>
                                                <li class="d-flex align-items-center mb-2">
                                                    <label class="mb-0 font-wi font-semibold text-dark-2">{{ trans('lang.store_address') }}</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="mb-0 font-wi font-semibold text-dark-2">{{ trans('lang.store_description') }}</label>
                        ...
                        <div class="card border">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <label class="mb-1 font-wi font-semibold text-dark-2">{{ trans('lang.store_phone') }}</label>
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        <label class="mb-1 font-wi font-semibold text-dark-2">{{ trans('lang.store_status') }}</label>
    ...
    <script>
        ...
        database.collection('settings').doc("AdminCommission").get().then(async function(snapshots) {
            ...
            if (commissionSetting.commissionType == "Percent") {
                ...
                const fixCommission = parseFloat(commissionSetting.fix_commission);
                if (!isNaN(fixCommission)) {
                    if (currencyAtRight) {
                        AdminCommission = fixCommission.toFixed(decimal_degits) + currentCurrency;
                    } else {
                        AdminCommission = currentCurrency + fixCommission.toFixed(decimal_degits);
                    }
                } else {
                    // Handle the case where fix_commission is not a valid number
                    console.error("Invalid fix_commission value:", commissionSetting.fix_commission);
                }
            }
        });
        ...
        async function getTotalpayment(driverID) {
            ...
            if (currencyAtRight) {
                totalPaidwithCurrency = parseFloat(paid_price).toFixed(decimal_degits) + "" + currentCurrency;
            } else {
                totalPaidwithCurrency = currentCurrency + "" + parseFloat(paid_price).toFixed(decimal_degits);
            }
            $("#total_payment").text(totalPaidwithCurrency);
            return paid_price;
        }
