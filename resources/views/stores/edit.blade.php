                        ...
                        <div class="menu-tab">
                            ...
                            <ul>
                                ...
                                <li class="active">
                                    ...
                                    <a href="{{ route('stores.edit', $id) }}">{{ trans('lang.store') }}</a>
                            ...
                            <div class="restaurant_payout_create-inner">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row width-100">
                                        ...
                                        <label class="col-3 control-label">{{ trans('lang.store_category') }}</label>
                                        ...
                                        <div class="col-7">
                                            ...
                                            <div class="form-text text-muted">
                                                ...
                                                {{ trans('lang.store_category_help') }}
        ...
        $(document).ready(function() {
            ...
            $(".edit-form-btn").click(async function() {
                ...
                if (restaurantname == '') {
                    ...
                    $(".error_top").append("<p>{{ trans('lang.store_category_error') }}</p>");
