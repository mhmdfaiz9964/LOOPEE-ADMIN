        ...
        if (rest_id) {
            database.collection('vendors').doc(rest_id).get().then(async function(snapshots) {
                ...
                if (vendorData) {
                    ...
                    $('#basic_tab').append('<a href="' + "{{ route('stores.view', ':id') }}".replace(':id', vendorData.id) + '">' + '{{ trans('lang.tab_basic') }}' + '</a>');
                    $('#food_tab').append('<a href="' + "{{ route('stores.items', ':id') }}".replace(':id', vendorData.id) + '">' + '{{ trans('lang.tab_items') }}' + '</a>');
                    $('#order_tab').append('<a href="' + "{{ route('stores.orders', ':id') }}".replace(':id', vendorData.id) + '">' + '{{ trans('lang.tab_orders') }}' + '</a>');
                    $('#promos_tab').append('<a href="' + "{{ route('stores.coupons', ':id') }}".replace(':id', vendorData.id) + '">' + '{{ trans('lang.tab_promos') }}' + '</a>');
                    $('#payout_tab').append('<a href="' + "{{ route('stores.payout', ':id') }}".replace(':id', vendorData.id) + '">' + '{{ trans('lang.tab_payouts') }}' + '</a>');
                    $('#payout_request').append('<a href="' + "{{ route('payoutRequests.stores.view', ':id') }}".replace(':id', vendorData.id) + '">' + '{{ trans('lang.tab_payout_request') }}' + '</a>');
