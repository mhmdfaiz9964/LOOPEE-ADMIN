                ...
                <fieldset>
                    ...
                    <div class="form-group row width-50">
                        ...
                        <div class="form-check">
                            ...
                            <label class="control-label" for="frontside">{{trans('lang.frontside')}}</label>
                    ...
                    <div class="form-group row width-50">
                        ...
                        <div class="form-check">
                            ...
                            <label class="control-label" for="backside">{{trans('lang.backside')}}</label>
                    ...
                    <div class="form-group row width-50">
                        ...
                        <div class="form-check">
                            ...
                            <label class="control-label" for="enable">{{trans('lang.enable')}}</label>
